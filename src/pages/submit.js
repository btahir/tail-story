...
import { submitIdea } from '../utils/firebaseActions';
...
function SubmitPage() {
	...
	const handleSubmit = async (event) => {
		...
		await submitIdea(title, summary, category)
		...
		<Layout>
				...
				<section>
					<form className="mx-auto md:w-1/2">
							...
							<button onClick={(e) => handleSubmit(e)} className="mt-4 px-6 py-2 text-md font-bold text-white bg-gray-700 border-b-4 border-gray-800 rounded hover:border-gray-700 hover:bg-gray-600">
									Submit
							</button>
					</form>
				</section>

  ...
  return (
    <Layout>
      ...
      <div className="flex justify-center mt-10 outline-none">
        {isLoggedIn ?
          <button onClick={() => manageStripeSubscription(profile.uid)} className="px-4 py-2 bg-teal-400 rounded text-gray-100 focus:outline-none">Manage Subscription</button>
          : null
        }
      </div>
    </Layout>

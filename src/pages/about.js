  ...
  return (
    <Layout>
      ...
      <p className="mt-12 text-lg text-gray-700">
        ...
        <br /><br /> <b>Diversity Hires</b> Since you're looking where other employers are not, you put yourself in a position to discover candidates with more diverse backgrounds.
      </p>
      <h3 className="my-8 text-center text-4xl tracking-tight leading-10 font-bold text-gray-900 sm:leading-none">
          Not for everyone
      </h3>   
      <p className="mt-12 text-lg text-gray-700">
        ...
        <br /><br /> Where we see this approach really working is for roles at smaller companies and for short term hires / contract roles in general. Since contract or short term roles
        are project based to begin with it makes sense to make the hiring search project based as well.
      </p>   
      </section>
    </Layout>
  );
